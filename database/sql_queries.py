...
SELECT * FROM reference WHERE OWNER_TELEGRAM_ID = ?
"""
...
UPDATE telegram_users SET REFERENCE_LINK = ? WHERE TELEGRAM_USER_ID = ?
"""

UPDATE_USER_BALANCE_QUERY = """
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE, 0) + 100 WHERE TELEGRAM_USER_ID = ?
"""
...
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE, 0) -?  WHERE TELEGRAM_USER_ID = ?
"""
...
INSERT_DONATE_TARNSACTIONS_QUERY = """
INSERT INTO donate_transactions VALUES(?,?,?,?)
"""

SELECT_LIKE_PROFILES = '''
